<?php 
   ...
   $no=0;
   $jenis=array('','Sembako','Komoditi Lain');
...
<div id="content">
  <div id="content-header">
    ...
    <h1>Informasi Harga Per Kecamatan</h1>
  </div>
      ...
      <div class="span6">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form action="index.php?hal=kecamatan&cari=ok" method="post" class="form-horizontal">
              <div class="control-group">
                <label class="control-label">Pilih Kecamatan</label>
                <div class="controls">
                  <select id="IdKecamatan" name="IdKecamatan"  class="form-control">
               <option value="Kepanjen">
               <?php if ($cari=="ok") { echo $IdKecamatan ;} else
                { echo "--Pilih Kecamatan--"; }?></option>
             ...
             <option value="Turen">Turen</option>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <select id="jenis_komoditi" name="jenis_komoditi"  class="form-control">
     <?php if ($cari=="ok") { echo $jenis_komoditi ;} else
      { echo "--Pilih komoditi--"; }?>
      ...
      <option value="Bawang">Bawang</option>
        <option value="Biji Bijian">Biji Bijian</option>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" placeholder="isi nama komoditi..." id="NamaKomoditi" name="NamaKomoditi" class="span5">
                </div>
              </div>
