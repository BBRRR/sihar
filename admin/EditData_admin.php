  ...
  <div class="container-fluid">
    ...
    <h4>
    	<?php
					 ...
					 echo 'Update Harga Komoditi Pasar :'.$pp->Kecamatan; ?>
    </h4>
      <div class="span11">
      ...
      <table width="100%"  border="0" cellspacing="0" cellpadding="0">
										...
										<input name="thn" type="text" value="<?php echo $thn;?>"  ></div></td>
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                <?php 
									   $no=0;
									   $query=mysql_query("select * from komoditi where IdKecamatan='".$_POST['IdKecamatan']."' and jenis_komoditi <> '3' order by jenis_komoditi, NamaKomoditi asc");
                    ...
                    <tr> 
                        ...
                        <td>
							...
							<input name="AutoID<?php echo $no;  ?>" type="hidden" value="<?php echo $x->AutoID; ?>">
							<input name="NamaKomoditi<?php echo $no;  ?>" type="hidden" value="<?php echo $x->NamaKomoditi; ?>">
							<input name="Kecamatan" type="hidden" value="<?php echo $x->Kecamatan; ?>">
							<input name="IdKecamatan" type="hidden" value="<?php echo $x->IdKecamatan; ?>">
							<input name="IdKomoditi<?php echo $no;  ?>" type="hidden" value="<?php echo $x->IdKomoditi; ?>">
                        </td>
